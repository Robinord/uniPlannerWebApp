...
namespace uniPlanner.Migrations
{
    ...
    [Migration("20230719003647_rankScore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("uniPlanner.Models.Programmes", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("UniProgrammesID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("uniPlanner.Models.Programmes", b =>
                {
                    b.HasOne("uniPlanner.Models.UniProgrammes", null)
                        .WithMany("ProgrammeID")
                        .HasForeignKey("UniProgrammesID");
                });

            modelBuilder.Entity("uniPlanner.Models.UniversityInfo", b =>
                {
                    b.HasOne("uniPlanner.Models.UniProgrammes", null)
                        .WithMany("UniversityID")
                        .HasForeignKey("UniProgrammesID");
                });

            modelBuilder.Entity("uniPlanner.Models.UniProgrammes", b =>
                {
                    b.Navigation("ProgrammeID");
